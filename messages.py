...
class DisconnectRequest(Message):
    def __init__(self, check_for_unreplicated_files):
        super(DisconnectRequest, self).__init__(MessageType.CONNECT_RESPONSE)
...
class DisconnectResponse(Message):
    def __init__(self, should_wait):
        super(DisconnectResponse, self).__init__(MessageType.CONNECT_RESPONSE)
...
class FileChanged(Message):
    def __init__(self, file_path, new_checksum, new_data, start_offset):
        super(FileChanged, self).__init__(MessageType.CONNECT_RESPONSE)
...
class ValidateChecksumRequest(Message):
    def __init__(self, file_path, file_checksum):
        super(ValidateChecksumRequest, self).__init__(MessageType.CONNECT_RESPONSE)
        self.file_path = file_path    
...
class ValidateChecksumResponse(Message):
    def __init__(self, file_path, valid):
        super(ValidateChecksumResponse, self).__init__(MessageType.CONNECT_RESPONSE)
        self.file_path = file_path
        self.valid = valid
...
class NewFileAvailable(Message):
    def __init__(self, file_path, file_checksum, file_data):
        super(NewFileAvailable, self).__init__(MessageType.CONNECT_RESPONSE)
        self.file_path = file_path    
        self.file_checksum = file_checksum
...
class DeleteRequest(Message):
    def __init__(self, file_path):
        super(DeleteRequest, self).__init__(MessageType.CONNECT_RESPONSE)
        self.file_path = file_path

# added (file_path) here
class DeleteResponse(Message):
    def __init__(self, file_path, can_delete):
        super(DeleteResponse, self).__init__(MessageType.CONNECT_RESPONSE)
        self.file_path = file_path 
...
class Delete(Message):
    def __init__(self, file_path):
        super(Delete, self).__init__(MessageType.CONNECT_RESPONSE)
        self.file_path = file_path   

# doc says (file_id, dest_path) changed to (source_path, dest_path)
class MoveRequest(Message):
    def __init__(self, source_path, dest_path):
        super(MoveRequest, self).__init__(MessageType.CONNECT_RESPONSE)
...
class MoveResponse(Message):
    def __init__(self, source_path, dest_path, valid):
        super(MoveResponse, self).__init__(MessageType.CONNECT_RESPONSE)
        self.source_path = source_path
        self.dest_path = dest_path
        self.valid = valid
...
class Move(Message):
    def __init__(self, source_path, dest_path):
        super(Move, self).__init__(MessageType.CONNECT_RESPONSE)
        self.source_path = source_path
        self.dest_path = dest_path
...
class ListRequest(Message):
    def __init__(self, dir_path=None):
        super(ListRequest, self).__init__(MessageType.CONNECT_RESPONSE)
...
class ArchiveRequest(Message):
    def __init__(self, file_path):
        super(ArchiveRequest, self).__init__(MessageType.CONNECT_RESPONSE)
        self.file_path = file_path

# added file_path
class ArchiveResponse(Message):
    def __init__(self, file_path, archived):
        super(ArchiveResponse, self).__init__(MessageType.CONNECT_RESPONSE)
        self.file_path = file_path
